...
load_checkpoint('output/checkpoint_threeloss_singlegrad200.pth'.format(modelNumber=modelNumber))
...
if Fig2bFlag==1:
    ...
    with torch.no_grad():
        ...
        recond, mu_color, log_var_color, mu_shape, log_var_shape, mu_location, log_var_location = vae(imgs, 'skip_cropped') #digit
